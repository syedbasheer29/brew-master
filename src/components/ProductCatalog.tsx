    ...
    <section id="products-section" className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <ShoppingBag className="h-12 w-12 mx-auto mb-4 text-brown-600 animate-float" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredAndSortedProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover-lift group">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 group-hover:text-brown-600 transition-colors">{product.name}</h3>
